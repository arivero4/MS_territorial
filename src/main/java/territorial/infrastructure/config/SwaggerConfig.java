    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Microservicio de gestión territorial agrícola. " +
                                "Administra departamentos, municipios, lugares de producción, " +
                                "predios, cultivos, lotes y plagas.")
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("Equipo de Desarrollo")
                                .email("dev@territorial.co"))
